...
// 1. Redux Store만들기 (app/store.js)
// 전역 state를 보관하는 저장소

// **createStored 더이상 사용하지 않아요 이젠

// configureStore를 쓰면 Redux Devtools 설정이 자동으로 추가됨
// (Redux Devtools는 크롭 웹 스토어에서 따로 설치 필요!)
export const store =  configureStore({
  // 4. Redux Store에 Slice Reducers 추가하기 (app/store.js)
  // Slice Reducer를 Store에 등록을 해야 컴포넌트들이 전역 state를 사용가능
  reducer:{
...
// Store 안에는 현재 전역상태와 리듀서가 들어가 있음 
