...
const counterSlice =  createSlice({
  ...
  reducers:{        // reducer들을 정의
    ...
    incrementByAmount:(state, action) => {  //두번째 파라미터: action객체= {type: 발생한액션의 타입, payload : 화물, 전달데이터}
...
export const { increment, decrement, incrementByAmount } = counterSlice.actions;      // 각 리듀서에 대한 액션 생성 함수들이 객체형태로 들어있음
...
// 현재 state와 action 객체를 파라미터로 받아오고 필요한 경우 상태를 업데이트 하고 
// 새 상태를 반환 하는 함수
